...
if __name__ == "__main__":
    ...
    parser.add_argument('-dirA', required=True, type=str, help='Ground-truth image directory.')
    parser.add_argument('-dirB', required=True, type=str, help='Restored image directory.')
